...
function __onEnable(__engine, __plugin, __script) {
    function initVersions_(){
        global.com = Packages.com;
        global.net = Packages.net;
        global.javax = Packages.javax;
    }
    function _echo() {
        var sender, msg;
...
//  global.Title = TitleAPI;
    ...
    global.pvpin_api = Packages.com.pvpin.gyhhy.jsrunntime.LocalApi.api;
    initVersions_();
    ...
    global.pvpin_npcs = null;
    __plugin.getLogger().info("Can't Find citizens Plugin. Download from");
    java.lang.System.out.print("https://dev.bukkit.org/projects/citizens");
    }
